                ...
                public void run()
                {
                    try
                    {
                        ...
                        if (data.isEnabled())
                        {
                            ...
                            if (data.isPersonal())
                            {
                                player.sendMessage(StrUtils.colorize(plugin.config.getString("bot.formatting").replace("%botname%", StrUtils.colorize(plugin.config.getString("bot.name"))).replace("%message%", session.think(message))));
                            } else
                            {
